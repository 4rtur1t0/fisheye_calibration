                                         ...
                                         vector<float>& perViewErrors, bool fisheye)
{
    ...
    cout << "Reprojecting on images according to calibration!!" << endl;
	...
	cout << "Showing image: " << s.imageList_detected[i] << endl;
        ...
        //Show ground truth with green circles
         for (cv::Point p:imagePoints[i]) {
        	cv::circle(view, p, 5, cv::Scalar(0, 255, 0), 2, cv::LINE_8, 0);
        }
